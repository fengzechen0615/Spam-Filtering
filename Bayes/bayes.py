...
# print(stop)
transformer = TfidfVectorizer(norm="l2", use_idf=True,stop_words=STOPWORDS)  #TF-IDF(term frequency-inverse document frequency)词频-逆向文件频率
svd = TruncatedSVD(n_components=30)  # 奇异值分解，降维
# print(svd)
...
print("Accuracy rate: " ,count / len(y_test))
